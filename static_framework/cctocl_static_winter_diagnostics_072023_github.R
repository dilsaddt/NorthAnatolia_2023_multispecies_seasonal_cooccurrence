...
ni = cctocl_static_winter_072023$mcmc.info$n.iter

# checking Rhat values, if there ara any over 1.1
hist(cctocl_static_winter_072023$summary[,8])
length(which(cctocl_static_winter_072023$summary[,8]>1.1))

rhats <- data.frame(params = names(cctocl_static_winter_072023$summary[,8]), rhat = as.numeric(cctocl_static_winter_072023$summary[,8]))

# traceplots
MCMCtrace(cctocl_static_winter_072023$samples, params = c("alphapsi.cc", "betapsi.cc", "alphap.cc"), pdf=F, ind = T, Rhat = T, n.eff = T, iter=ni)
MCMCtrace(cctocl_static_winter_072023$samples, params = c("randompsi.cc", "randomp.cc"), pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)

MCMCtrace(cctocl_static_winter_072023$samples, params = c("alphapsi.cl", "betapsi.cl", "alphap.cl"), pdf=F, ind = T, Rhat = T, n.eff = T, iter=ni)
MCMCtrace(cctocl_static_winter_072023$samples, params = c("randompsi.cl", "randomp.cl"), pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)

par(mfrow=c(1,1))
# caterpillar plots
MCMCplot(cctocl_static_winter_072023$samples, params = c("alphapsi.cc", "betapsi.cc", "alphap.cc"), ref_ovl = T)
MCMCplot(cctocl_static_winter_072023$samples, params = c("randompsi.cc", "randomp.cc"), ref_ovl = T)

MCMCplot(cctocl_static_winter_072023$samples, params = c("alphapsi.cl", "betapsi.cl", "alphap.cl"), ref_ovl = T)
MCMCplot(cctocl_static_winter_072023$samples, params = c("randompsi.cl", "randomp.cl"), ref_ovl = T)
...
mcmc_areas(cctocl_static_winter_072023$samples,

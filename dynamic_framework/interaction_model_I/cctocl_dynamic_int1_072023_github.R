...
# interaction 1 models: season*popden
...
cat(file = "cctocl_dynamic_int1_072023.txt"," 
model {

# Model: cctocl_dynamic_int1_072023
#
# initial occupancy (psi1) = habitat + popden + habitat:popden + re(area)
# colonization (gamma) = season + popden + season:popden + re(area)
# desertion (epsilon) = season + popden + season:popden + re(area)
...
cctocl_dynamic_int1_072023 <- jags(jags.data, inits, params, "cctocl_dynamic_int1_072023.txt", n.chains = nc, n.adapt = na, n.iter = ni, n.burnin = nb, n.thin = nt, parallel = T)

end <- Sys.time()

end - start

print(cctocl_dynamic_int1_072023)

...
ni = cctocl_dynamic_int2_072023$mcmc.info$n.iter

# checking Rhat values, if there ara any over 1.1
hist(cctocl_dynamic_int2_072023$summary[,8])
length(which(cctocl_dynamic_int2_072023$summary[,8]>1.1))

rhats <- data.frame(params = names(cctocl_dynamic_int2_072023$summary[,8]), rhat = as.numeric(cctocl_dynamic_int2_072023$summary[,8]))

# traceplots
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = c("alphapsi.cc", "betapsi.cc",
                                                                 "alphagamma.cc", "betagamma.cc",
                                                                 "alphaeps.cc","betaeps.cc", 
                                                                 "alphap.cc", "betap.cc"), pdf=F, ind = T, Rhat = T, n.eff = T, iter=ni)

MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randompsi.cc", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomgamma.cc", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomeps.cc", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomp.cc", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)

MCMCtrace(cctocl_dynamic_int2_072023$samples, params = c("alphapsi.cl", "betapsi.cl",
                                                                 "alphagamma.cl", "betagamma.cl",
                                                                 "alphaeps.cl","betaeps.cl", 
                                                                 "alphap.cl", "betap.cl"), pdf=F, ind = T, Rhat = T, n.eff = T, iter=ni)

MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randompsi.cl", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomgamma.cl", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomeps.cl", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)
MCMCtrace(cctocl_dynamic_int2_072023$samples, params = "randomp.cl", pdf=F, ind = T, Rhat = T, n.eff = T,iter=ni)

# caterpillar plots

par(mfrow=c(1,1))
MCMCplot(cctocl_dynamic_int2_072023$samples, params = c("alphapsi.cc", "betapsi.cc",
                                                                "alphagamma.cc", "betagamma.cc",
                                                                "alphaeps.cc","betaeps.cc", 
                                                                "alphap.cc", "betap.cc"), ref_ovl = T)

par(mfrow=c(2,2))
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randompsi.cc", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomgamma.cc", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomeps.cc", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomp.cc", ref_ovl = T)

par(mfrow=c(1,1))
MCMCplot(cctocl_dynamic_int2_072023$samples, params = c("alphapsi.cl", "betapsi.cl",
                                                                "alphagamma.cl", "betagamma.cl",
                                                                "alphaeps.cl","betaeps.cl", 
                                                                "alphap.cl", "betap.cl"), ref_ovl = T)

par(mfrow=c(2,2))
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randompsi.cl", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomgamma.cl", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomeps.cl", ref_ovl = T)
MCMCplot(cctocl_dynamic_int2_072023$samples, params = "randomp.cl", ref_ovl = T)
...
plot_title <- ggtitle("Roe deer with gray wolf | int2 | Posterior distributions",
...
mcmc_areas(cctocl_dynamic_int2_072023$samples,
